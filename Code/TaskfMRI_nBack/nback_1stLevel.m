...
% The script assumes two nback sessions included in a folder titled 'NBACK' that have undergone preprocessing. Both folders are required 
% in a folder named as the participant id. A 'Timing' folder containing .m files with the onsets and durations is also required. The folders should be within the
