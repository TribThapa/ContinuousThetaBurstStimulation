...
pathIn = 'H:\My Drive\Science\Projects\projects\2016_cTBS_GABA_SCZ\NBACK outputs\003_NR\';
...
for i = 1:size(cond,1)
    ...
    save([ID,'_',cond{i,1},'.mat'],'onsets','durations','names');
end